...
import { Course } from '@/interfaces/properties'

interface Props {
  item: Course
}

const PropertyCardItem: FC<Props> = ({ item }) => {
  return (
    <Box
      sx={{
        px: 1,
    ...
    >
      ...
      >
        ...
        <Box sx={{ mb: 2 }}>
          ...
          <Typography component="h3" variant="h5" sx={{ mb: 2, overflow: 'hidden', fontSize: '0.8rem' }}>
            {item.details}
          </Typography>
        </Box>
      </Box>
